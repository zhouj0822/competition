...
<div class="img">
   <a target="_blank" href="">
     <img src="/img/1.jpg" alt="图片文本描述" >
     </a>
     <div class="desc">数学竞赛</div>
  <a href="Releasecompetition4.html" class="button" style="text-decoration: none;">编辑</a>
  <a href="" class="button" style="text-decoration: none;">删除</a>   
</div>  <div class="img">
   <a target="_blank" href="">
     <img src="/img/2.jpg" alt="图片文本描述" >
     </a>
  ...
  <div class="img">
   <a target="_blank" href="">
     <img src="/img/3.jpg" alt="图片文本描述" >
     </a>
     <div class="desc">网络安全技能大赛</div>
  <a href="Releasecompetition4.html" class="button" style="text-decoration: none;">编辑</a>
  <a href="" class="button" style="text-decoration: none;">删除</a>   
</div>
  <div class="img">
   <a target="_blank" href="">
     <img src="/img/4.jpg" alt="图片文本描述" >
     </a>
     <div class="desc">软件设计大赛</div>
  <a href="Releasecompetition4.html" class="button" style="text-decoration: none;">编辑</a>
  <a href="" class="button" style="text-decoration: none;">删除</a>   
</div>
  <div class="img">
   <a target="_blank" href="">
     <img src="/img/5.jpg" alt="图片文本描述" >
     </a>
  ...
  <div class="img">
   <a target="_blank" href="">
     <img src="/img/6.jpg" alt="图片文本描述" >
     </a>
     <div class="desc"  > 更多</div> 
     
 <a href="/manager/game" class="button" style="text-decoration: none;">查看</a>
