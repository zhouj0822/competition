...
<ul class="topmenu">
  ...
  <a href="/user/index">
      <span class="glyphicon glyphicon-user" style="float: right;margin-top: 13px;margin-right:20px;color: white;">&nbsp;你所在的位置：发布指导信息</span>
    </a>
...
<form action="" method="post" enctype="multipart/form-data" name="input">
   <div class="content1" ><label >比赛名称:</label>
    <div class="dropdown" style="float:left;"><input type="text" name="gname" value="${game.gname }"></input>

    </div>
  </div></div>
  <div class="content1"><label>指导教师:</label><input type="text" name="name"  value="${zhidao.name }"></input></div>
  <div class="content1"><label>标题:</label><input type="text" name="ztitle" value="${zhidao.ztitle }"></input></div>
  <div class="content1"><label>指导内容:</label><input type="text" name="ztext" value="${zhidao.ztext }"></input></div>
   <div class="content1"><input type="submit" value="发布"></button></div>
