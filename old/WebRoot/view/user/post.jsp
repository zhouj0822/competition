...
<form action="/user/post" method="post" enctype="multipart/form-data">
  <div class="log">
      ...
      <div class="log1">图片
      <input class="pic" type='file' name='xid'></input>
      </div>
  </div>
  <div class="text">内容</div>
  <input class="textt" type="text" name='text'></input>
  <div class="log"> 
      <a href="#"><input class="login1" type='submit' value='发布'></input></a>
      <a href="/user/shequ"><input class="login2" type='button' value='取消'></input></a>
  </div>
  </br></br></br>
