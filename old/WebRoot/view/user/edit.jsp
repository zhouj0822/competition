...
<ul class="topmenu">
 ...
 <form action="" method="post">
    ...
    <div class='bb'>性别</div>
    <select class='text' name="sex" value="${user.sex }">
        <script>
 ...
 <div class='bbb'>学院
    <select class='aaa' name="academy" value="${user.academy }">
     <script>
         var  Sel=document.getElementById("citySel");
         var index=Sel.selectedIndex ;             // selectedIndex是所选中的项的index
         myselect.options[index].value;
...
<div class='bbb'>新密码
 <input type="text" name="password" value="${user.password }">
   ...
   <div><input class="login" type='button' value='确认更改' onclick="myFunction()"></input></div>
    <div><a href="首页.html"><input class="loginn" type='button' value='返回首页'></input></a></div>
</form>
<script>
function myFunction(){
  alert("确认保存更改信息？");
