...
<img id="pic" src="/img/login.jpg" width="1084px" height='380px'></img>
...
<form action="/user/login" method="post">
    <div class="log">
      <div class="log1" style="background-image:url('${basePath } /img/people.jpg')">
        <img id="pic" src="/img/people.jpg" width='15px' height='15px'></img>
        <input type="text" name="userid" placeholder="学号/student ID" value="${user.userid }"></input>
      </div><br/>
      <div class="log1" style="background-image:url('${basePath } /img/log.jpg')">
        <img id="pic" src="/img/log.jpg" width='15px' height='15px'></img>
        <input type="password" name="password" placeholder="密码/password" value="${user.password }"></input>
      </div><br/>
      <a href="/user/Topp"><input class="login" type='submit' value='登录'></input></a><br/><br/>
      <div><a href="/user/zhuce">没有账号？点这里注册</a></div><br/><br/><br/>
    </div>
