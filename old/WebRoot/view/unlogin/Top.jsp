...
<div class='ban' style="width: 1083px;margin:0px auto;background-image:url('${basePath } /img/logo.jpg')">
  
  <form action="" method="post">
  <img class='logo' src="/img/logo.jpg" width='210px' height='70px'></img>
  <input class="log" type="text" id="title"name='title' placeholder="输入关键词" value="${news.title }"></input>
  <input class="log1" type='submit' value='搜索'></input>
  </form>
...
<div id="myCarousel" class="carousel slide">
  ...
  <div class="carousel-inner">
    <div class="item active" style="height:100%;background-image:url('${basePath } /img/head.jpg')">
      <img src="/img/head.jpg">
    </div>
    <div class="item" style="height:100%;background-image:url('${basePath } /img/head1.jpg')">
      <img src="/img/head1.jpg" width="100%">
    </div>
    <div class="item" style="height:100%;background-image:url('${basePath } /img/head2.jpg')">
...
<div>
<img src="/img/linee.jpg" width="1100px"  height='10px'></img>
</div>
<div class="footer" style="height:100%;background-image:url('${basePath } /img/news.jpg')">
