...
<ul class="topmenu">
  ...
  <a href="/user/index">
      <span class="glyphicon glyphicon-user" style="float: right;margin-top: 13px;margin-right:20px;color: white;">&nbsp;你所在的位置：发布成功</span>
    </a>
...
<div style="margin-top: 300px;margin-left: 600px;"><br>恭喜你！发布成功</div>
<div class="footer">
  <div>联系电话buyaoda</div>
</div>
</div>
