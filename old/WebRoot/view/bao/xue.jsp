...
<div class="responsive">
  <div class="img">
    <a target="_blank" href="/bao/xue1">
      <img src="/img/xue1.jpg" alt="图片文本描述" width="270" height="180">
    </a>
    <div class="desc">大学生数学竞赛</div>
    <a href="Releasecompetition4.html" class="button" style="text-decoration: none;">添加</a>
  </div>
  <div class="img">
    <a target="_blank" href="/bao/xue1">
      <img src="/img/xue2.jpg" alt="图片文本描述" width="270" height="180">
    </a>
    <div class="desc">电子信息技术应用大赛</div>
    <a href="Releasecompetition4.html" class="button" style="text-decoration: none;">添加</a>
  </div>
  <div class="img">
    <a target="_blank" href="/bao/xue1">
      <img src="/img/xue3.jpg" alt="图片文本描述" width="270" height="180">
    </a>
    <div class="desc">大学生网络安全技能大赛</div>
    <a href="Releasecompetition4.html" class="button" style="text-decoration: none;">添加</a>
  </div>
  <div class="img">
    <a target="_blank" href="详细信息a.html">
      <img src="/img/xue4.jpg" alt="图片文本描述" width="270" height="180">
    </a>
    <div class="desc">大学生软件设计大赛</div>
    <a href="Releasecompetition4.html" class="button" style="text-decoration: none;">添加</a>
  </div>
  <div class="img">
    <a target="_blank" href="/bao/xue1">
      <img src="/img/xue5.jpg" alt="图片文本描述" width="270" height="180">
    </a>
    <div class="desc">网络空间攻防大赛</div>
    <a href="Releasecompetition4.html" class="button" style="text-decoration: none;">添加</a>
  </div>
  <div class="img">
    <a target="_blank" href="/bao/xue1">
      <img src="/img/xue6.jpg" alt="图片文本描述" width="270" height="180">
    </a>
    <div class="desc">红帽挑战赛</div>
    <a href="Releasecompetition4.html" class="button" style="text-decoration: none;">添加</a>
  </div>
  <div class="img">
    <a target="_blank" href="/bao/xue1">
      <img src="/img/xue7.jpg" alt="图片文本描述" width="270" height="180">
    </a>
    <div class="desc">课外学术科技作品竞赛</div>
    <a href="Releasecompetition4.html" class="button" style="text-decoration: none;">添加</a>
  </div>
