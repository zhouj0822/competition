...
<div class="responsive">
  ...
  <div class="img">
    <a target="_blank" href="/bao/si1">
      <img src="/img/si6.jpg" alt="图片文本描述" width="270" height="180">
    </a>
    <div class="desc">“我诚信·我快乐”演讲比赛</div>
    <a href="/bao/my" class="button" style="text-decoration: none;">添加</a>
  </div>
  <div class="img">
    <a target="_blank" href="/bao/si1">
      <img src="/img/si7.jpg" alt="图片文本描述" width="270" height="180">
    </a>
    <div class="desc">“学宪法讲宪法”知识竞赛</div>
    <a href="Releasecompetition4.html" class="button" style="text-decoration: none;">添加</a>
  </div>
